...
<styleSheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  </footer>`}function $e(){return`<a class="header-icon-link" href="https://github.com/tommasodesantis/appealcompass" target="_blank" rel="noreferrer">${J()}<span>View on GitHub</span><span class="sr-only"> (opens in new tab)</span></a>`}function Re(){let e=w?"":" disabled",t=w?`<div class="cf-turnstile" data-sitekey="${r(S)}"></div>`:'<p class="hint">Problem reporting is disabled until the Turnstile site key is configured.</p>';return`<section id="report-panel" class="report-panel" hidden>
